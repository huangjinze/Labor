...
@section('header')
	<div class="testimonials" style="background: url('{{asset('images/lwwb-header.jpg')}}') no-repeat 0px 0px fixed;">
		<div class="container">
					...
					<div class="latest-news-grids">
						<div class="col-md-3 latest-news-grid">
							<div class="col-xs-5 latest-news-grid-left">
								<img src="{{asset('uploads/images/'.$datas[$i]->cover.'')}}" alt=" " height="200px" width="200px" class="img-responsive">
							</div>
							<div class="col-xs-7 latest-news-grid-right">
								...
								<h4><a href="/lwwb/{{$datas[$i]->id}}">{{$datas[$i]->title}}</a></h4>
								<p class="man"></p>
							</div>
